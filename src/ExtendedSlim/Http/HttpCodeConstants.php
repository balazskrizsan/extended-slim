...
final class HttpCodeConstants
{
    ...
    const MULTI_STATUS                  = 207; // (WEBDAV)
    const ALREADY_REPORTED              = 208; // (WEBDAV)
    const IM_USED                       = 226;
    ...
    const PERMANENT_REDIRECT = 308; // (EXPERIEMENTAL)
    ...
    const I_M_A_TEAPOT                         = 418; // (RFC 2324)
    const ENHANCE_YOUR_CALM                    = 420; // (TWITTER)
    const UNPROCESSABLE_ENTITY                 = 422; // (WEBDAV)
    const LOCKED                               = 423; // (WEBDAV)
    const FAILED_DEPENDENCY                    = 424; // (WEBDAV)
    const RESERVED_FOR_WEBDAV                  = 425;
    ...
    const BANDWIDTH_LIMIT_EXCEEDED        = 509; // (APACHE)
